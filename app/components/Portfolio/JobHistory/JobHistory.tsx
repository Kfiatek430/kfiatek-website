    ...
    return (
        <div className={styles.container}>
            <div className={`flex flex-col items-center w-1/2 ${styles.subcontainer}`}>
                <h2 className='text-3xl md:text-5xl mr-[2.3rem] mb-10 text-center'>Education</h2>
            ...
            <div className={`flex flex-col items-center w-1/2 ${styles.subcontainer}`}>
                <h2 className={`${styles.h2} text-3xl md:text-5xl mr-[2.3rem] mb-10 text-center`}>Experience</h2>
                <div className={styles.contentFuture}>
                    <div className='text-base md:text-xl text-[var(--green)]'><i className='bx bxs-calendar mr-2'></i>Maybe in future ?</div>
                </div>

                <div className={styles.content}>
                    <div className='text-base md:text-xl text-[var(--green)]'><i className='bx bxs-calendar mr-2'></i>August 2024</div>
                    ...
                    As part of an educational project during my internship, I developed a web application for managing the company’s vehicle fleet. Using HTML, CSS, JavaScript, and PHP, I created a system that streamlined fleet organization, enhancing efficiency in the management process.                     </p>
                </div>
            </div>
        </div>
    )
